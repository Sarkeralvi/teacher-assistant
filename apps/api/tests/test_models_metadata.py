...
EXPECTED_COLUMNS = {
    ...
    "answer_regions": {
        ...
        "full_answer_verification_source",
...
EXPECTED_INDEX_COLUMNS = {
    ...
    "bulk_evaluation_runs": {"assessment_id", "grading_run_id"},
    "bulk_evaluation_items": {"run_id", "submission_id", "question_id"},
