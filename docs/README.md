...
- [Custom Controlled V0 Teacher Quick Start](CUSTOM_CONTROLLED_V0_TEACHER_QUICK_START.md)
- [Real Teacher Observed Synthetic Pilot Protocol](REAL_TEACHER_OBSERVED_SYNTHETIC_PILOT_PROTOCOL.md)
