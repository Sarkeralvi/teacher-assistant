...
class LocalReferenceExtractor:
    def __init__(
        ...
        *,
        ...
        try:
            ...
            self.qwen_adapter = qwen_adapter or BrainAdapter.for_provider(
                self.settings, "llama_cpp_qwen"
            )
            if self.qwen_adapter.provider.provider_name != "llama_cpp_qwen":
    ...
    def ocr_pages(
        ...
        rendered = self._render_pages(file_path, content_type)
