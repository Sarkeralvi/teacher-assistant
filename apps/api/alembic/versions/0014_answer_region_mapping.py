...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("teacher_confirmed", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_index("ix_answer_region_mappings_assessment_id", "answer_region_mappings", ["assessment_id"])
    op.create_index("ix_answer_region_mappings_submission_id", "answer_region_mappings", ["submission_id"])
    op.create_index("ix_answer_region_mappings_question_node_id", "answer_region_mappings", ["question_node_id"])
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ux_answer_region_mappings_submission_question_node", table_name="answer_region_mappings")
    ...
    op.drop_constraint("fk_answer_regions_question_node_id_question_nodes", "answer_regions", type_="foreignkey")
