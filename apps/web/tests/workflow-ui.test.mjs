...
for (const marker of [
  ...
  "Confirm faithful final-intent transcription",
  "identifies cancellations and replacements",
  ...
  "qwen38-final-intent-thinking-repair-v6",
  ...
  "Repair still wrong — block grading",
